...
def summaryTableNCC(validation_prediction_folder, input_data_folder, validation_points, outdir):
    ...
    for file in files:
        ...
        ## Get mean, standard deviation, and RMSE of angular/magnitude error
        filename = file.name
        dict = utils.rmseDict(magnitude_error, signed_angular_error, filename, remove_stat_pixels = False)
        all.append(dict)
        ...
        dict = utils.rmseDict(magnitude_error, signed_angular_error, filename, remove_stat_pixels = True)
        all.append(dict)
        ...
        dict = utils.rmseDict(magnitude_error, signed_angular_error, filename, remove_stat_pixels = False, correlation_mask = True)
        all.append(dict)
        ...
        dict = utils.rmseDict(magnitude_error, signed_angular_error, filename, remove_stat_pixels = True, correlation_mask = True)
        all.append(dict)

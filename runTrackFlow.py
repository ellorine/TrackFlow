...
def runTrackFlow(config_path, global_overwrite = False):    
    ...
    if True: 
        ...
        tr.interpolateSparseDisplacements(output_dir / "fullfield" / "ncc_average_hillshade.csv", 
        ...
        tr.interpolateSparseDisplacements(project_directory / "1_Data" / "3_CIAS" / "results_fullfield" / "ncc_hillshade_azi315_ang45.csv", 
                                           output_dir / "fullfield" / "geotiff", "ncc_hillshade_azi315_ang45", ref_dsm = list_of_dsms[1], filter_on_correlation_coeff = False)
        
        
    
        # Single Hillshade
        print("Working on Multidirectional Hillshade Grid...")
        tr.interpolateSparseDisplacements(project_directory / "1_Data" / "3_CIAS" / "results_fullfield" / "ncc_hillshade_multidirectional.csv",
                                            output_dir / "fullfield" / "geotiff", "ncc_hillshade_multidirectional", ref_dsm = list_of_dsms[1], filter_on_correlation_coeff = False)
        
        ## Ortho
        print("Working on Ortho Grid...")
        tr.interpolateSparseDisplacements(project_directory / "1_Data" / "3_CIAS" / "results_fullfield" / "ncc_ortho_image.csv", 
                                           output_dir / "fullfield" / "geotiff", "ncc_ortho_image", ref_dsm = list_of_dsms[1], filter_on_correlation_coeff = False)
        
        print("Working on Ortho 50cm Grid...")
        tr.interpolateSparseDisplacements(project_directory / "1_Data" / "3_CIAS" / "results_fullfield" / "ncc_ortho_image_50cm.csv",
                                           output_dir / "fullfield" / "geotiff", "ncc_ortho_image_50cm", 
                                           ref_dsm = Path(r"X:\zdatarepository\17-004_Matariki\3DCD\tehoro_3dcd_v1-0\20180207_qldc_asltd_v1-0\ortho\20180000_otagorural_30cm_mosaic_snap_intensity_50cm.tif"), 
                                           filter_on_correlation_coeff = False,
                                           scale_to_dsm=False, scale_measure=0.5)
        ...
        print("Working on Average Hillshade Grid with Correlation Filter...")
        tr.interpolateSparseDisplacements(output_dir / "fullfield" / "ncc_average_hillshade_filtered.csv",
    ...
    if True:
        ...
        thplt.plot3DVelocitiesClippingExtent_3x2([folder / "Optical_Flow_Pair_2018-02-07_2020-02-09_ortho.tif", cc_folder / "ncc_ortho_image.tif",
                                                  folder / "Optical_Flow_Pair_2018-02-07_2020-02-09_multi_hs.tif", cc_folder / "ncc_hillshade_multidirectional.tif",
                                                  ...
                                                  ["A.1 - Optical Flow, Ortho (2m)", "A.2 - NCC, Ortho (2m)", "B.4 - Optical Flow, Multidirectional Hillshade", "B.5 - NCC, Multidirectional Hillshade",

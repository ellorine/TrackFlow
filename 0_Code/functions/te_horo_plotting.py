...
def plotValidationPredictionScatter_4x2(validation_data, project_dir, outfolder):
    ...
    #ortho data
    ortho_ncc = pd.read_csv(project_dir / "3_CIAS_Results" / "validation" / "validation_ncc_ortho_image.csv")
    ortho_of = pd.read_csv(project_dir / "2_Optical_Flow_Results" / "validation"/ "Validation_Subset_ortho.csv")

    #hs data
    hs_ncc = pd.read_csv(project_dir / "3_CIAS_Results" / "validation" / "validation_ncc_hillshade_azi315_ang45.csv")
